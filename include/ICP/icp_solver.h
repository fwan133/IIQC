...
//            std::cout << "GICP converged with score: " << gicp.getFitnessScore() << std::endl;
        ...
        boost::shared_ptr<ScaleEstimationSVD<pcl::PointXYZ, pcl::PointXYZ, double>> pestiS = boost::make_shared<ScaleEstimationSVD<pcl::PointXYZ, pcl::PointXYZ, double>>();
        boost::shared_ptr<pcl::registration::TransformationEstimation<pcl::PointXYZ, pcl::PointXYZ, double>> pS = pestiS;
